    ...
    <div className="absolute left-20 right-20 top-40">
      <Card>
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl">Create Investment</CardTitle>
          <CardDescription>
            Create your next win with IncedoInvest
          </CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4">
          <div className="grid grid-cols-2 gap-6">
            <div className="grid gap-2">
              <Label htmlFor="firstname">Investment Name</Label>
              <Input id="firstname" type="text" placeholder="Investment Name" />
            </div>
                  ...
                  render={() => (
                    <FormItem>
                      <div className="mb-4">
                        ...
                        <FormDescription>
                          Select the investment type you want to invest in.
                        </FormDescription>
                      </div>
                      {items.map((item) => (
                        <FormField
